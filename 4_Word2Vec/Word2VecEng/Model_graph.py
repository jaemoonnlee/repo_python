...
# 2-1
X_inputs = tf.compat.v1.placeholder(tf.int32, shape=[batch_size]) # X
Y_inputs = tf.compat.v1.placeholder(tf.int32, shape=[batch_size, 1]) # Y
...
# 2-3
nce_W = tf.Variable(tf.random.truncated_normal([vocabulary_size, embedding_size],
